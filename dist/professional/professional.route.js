...
import { add, findOne, findall, getProf, getProfByHealthAndSpeciality, getProfByHealthInsurance, remove, update, } from './professional.controler.js';
...
professionalRouter.get('/:speciality/speciality/:healthInsurance/healthInsurance', (req, res, next) => authMiddleare.authenticateToken(req, res, next), (req, res) => getProfByHealthAndSpeciality(req, res));
